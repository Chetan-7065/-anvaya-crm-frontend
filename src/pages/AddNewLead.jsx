  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response) {
        ...
        toast.error("Error while Adding New Lead successfully");
  ...
  return (
    <>
      <main className="container-fluid px-2 px-sm-3 px-md-4">
        <div className="row ">
          <div
            className="col-12 mx-auto mt-2 mt-md-4"
          ...
          >
            <div className="card shadow-lg border-2 border-light rounded-3 overflow-hidden">
              <div className="card-header bg-white py-3 py-md-4 border-bottom border-4 border-primary">
                <h2 className="mb-0 fw-bold text-primary text-center fs-3 fs-md-2">
                  Add New Lead
                </h2>
              </div>
              ...
              <div className="card-body p-3 p-sm-4 p-md-5 bg-white">
                <form onSubmit={handleSubmit} className="row g-1">
                  ...
                  <div className="col-12 mb-3 mb-md-4">
                    ...
                    >
                      {leadSource.map((source, index) => {
                        return (
                          <option key={index + 1} value={source}>
                            {source}
                          </option>
                        );
                      })}
                  ...
                  <div className="col-12 col-md-5 d-grid mt-2 mt-md-3">
                    <button
                      type="submit"
                      className="btn btn-primary fw-bold shadow-sm text-uppercase btn-sm btn-md-lg py-2 py-md-3 fs-6 fs-md-4"
                    >
                      Create Lead
                    </button>
                  </div>
